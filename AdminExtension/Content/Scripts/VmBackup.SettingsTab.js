...
/*globals,jQuery,trace,cdm,VmBackupAdminExtension,waz,Exp*/
(function ($, global, Shell, Exp, undefined) {
    ...
    function onSaveSettings() {
        ...
        newSettings = $.extend(true, {}, global.VmBackupAdminExtension.Controller.getCurrentAdminSettings());
        ...
        global.VmBackupAdminExtension.Controller.updateAdminSettings(newSettings)
            .done(function (data, textStatus, jqXHR) {
                progressOperation.complete("Successfully updated settings.", Shell.UI.InteractionSeverity.information);
                global.VmBackupAdminExtension.Controller.invalidateAdminSettingsCache();
    ...
    function onDiscardSettings() {
        renderPage(global.VmBackupAdminExtension.Controller.getCurrentAdminSettings());
        updateContextualCommands(false);
    }
    ...
    global.VmBackupAdminExtension.SettingsTab = {
        loadTab: loadTab,
        cleanup: cleanup
    };
