...
{   
    ...
    {
        /// <summary>
        /// Address of VmBackup resource provider
        /// </summary>
        public string EndpointAddress { get; set; }

        /// <summary>
        /// Username used by Admin API to connect with VmBackup Resource Provider
        /// </summary>
        public string Username { get; set; }

        /// <summary>
        /// Password used by Admin API to connect with VmBackup Resource Provider
        /// </summary>
        ...
        public TenantEndpoint ToTenantEndpoint()
        {
            return new TenantEndpoint()
            {
                ...
                AuthenticationUsername = this.Username,
                AuthenticationPassword = this.Password,
                SourceUriTemplate = string.Format(CultureInfo.InvariantCulture, "{{subid}}/services/{0}/{{*path}}", VmBackupClient.RegisteredServiceName),
