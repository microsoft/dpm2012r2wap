...
{
    public class VmBackupApi : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            var configServerConnectionString = ConfigurationManager.ConnectionStrings["VmBackupResourceProviderConnectionString"].ConnectionString;
            WebApiConfig.Register(GlobalConfiguration.Configuration, configServerConnectionString);
        ...
        protected void Application_AuthenticateRequest(Object sender, EventArgs e)
        {
            ...
            //2. Add Microsoft.WindowsAzure.Server.Common.dll to c:\inetpub\MgmtSvc-VmBackup\bin
