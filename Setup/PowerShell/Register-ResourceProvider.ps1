...
$hostName = "$env:ComputerName" + ":30033"
$userName = "admin"
$password = "pass@word1"
...
$rpSettings = @{
    'Name' = $rpName;
    'DisplayName' = 'Virtual Machine Backup';
    'InstanceDisplayName' = 'Virtual Machine Backup';
