...
(function (global, $, undefined) {
    ...
    function onOpened() {
        ...
        global.AppExtension.UserContext.populateOrHideSubscriptionsDropDown("subscriptions", null, null, null, null, "vmbackup");
    }

    // Public Methods
    function onOkClicked() {
        global.VmBackupTenantExtension.Controller.createFileShare(this.subscriptionId, this.fileShareName, this.size, this.fileServerName);
    }

    function getSubscriptions() {
        return global.Exp.Rdfe.getSubscriptionsRegisteredToService(global.VmBackupTenantExtension.serviceName);
    }

    global.VmBackupTenantExtension = global.VmBackupTenantExtension || {};
    global.VmBackupTenantExtension.ViewModels = {
